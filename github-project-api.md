...
> * [removeAssigneesFromAssignable](/en/graphql/reference/mutations#removeassigneesfromassignable)
> * [addLabelsToLabelable](/en/graphql/reference/mutations#addlabelstolabelable)
> * [removeLabelsFromLabelable](/en/graphql/reference/mutations#removelabelsfromlabelable)
> * [updateIssue](/en/graphql/reference/mutations#updateissue)
> * [updatePullRequest](/en/graphql/reference/mutations#updatepullrequest)
> * [transferIssue](/en/graphql/reference/mutations#transferissue)
...
You can use webhooks to subscribe to events taking place in your project. For example, when an item is edited, GitHub can send a HTTP POST payload to the webhook's configured URL which can trigger automation on your server. For more information about webhooks, see [About webhooks](/en/webhooks-and-events/webhooks/about-webhooks). To learn more about the `projects_v2_item` webhook event, see [Webhook events and payloads](/en/webhooks-and-events/webhooks/webhook-events-and-payloads#projects_v2_item).